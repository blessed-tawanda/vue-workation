<template>
  <div class="bg-gray-100 h-screen">
    <div class="px-10 py-8 max-w-xl mx-auto lg:max-w-full lg:px-0 lg:py-20 lg:relative lg:min-h-screen">
